            ...
            <main className='flex flex-col items-center justify-center w-full flex-1 px-4 sm:px-6 lg:px-8 text-center'>
                <div className='bg-white rounded-2xl shadow-2xl flex flex-col md:flex-row w-full max-w-4xl '>
                    <div className='w-full md:w-3/5 p-5'>
                        ...
                        <div className='py-10'>
                            <h2 className="text-3xl font-bold text-green-400 mb-2 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">Sign up for an Account</h2>
                            <p className="text-md text-green-300 mb-2 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">Please fill out the information below and sign up</p>
                        ...
                        <form className='flex flex-col items-center ' onSubmit={handleSubmit}>
                            ...
                            <button className='border-2 border-green-400 text-green-400 rounded-full px-6 md:px-12 py-2 inline-block font-semibold hover:bg-green-400 hover:text-white mt-5 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110' type="submit" disabled={isLoading}>Signup</button>
                        </form>
                    </div>
                    <div className=' w-full md:w-2/5 bg-green-400 text-white rounded-tr-2xl rounded-br-2xl py-10 md:py-36 px-6 md:px-12 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110'>
                        <img className="mb-10" src={require('../assets/welcome.png')} alt="Welcome" />
                    </div>
                </div>
            </main>
        </div>
